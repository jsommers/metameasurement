...
python3 metameasurement.py -Mrtt:interface=eth0:type=ping:dest=10.0.1.1 -c "sleep 3600" -f overhead_1hrttonly -l
python3 metameasurement.py -Mcpu -Mmem -Mio -Mnetstat -Mrtt:interface=eth0:type=ping:dest=10.0.1.1 -c "sleep 3600" -f overhead_1hallmon -l
